...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ConfigStorage__ = __webpack_require__(4);
...
(function ($, window, document) {
  ...
  */
  ...
  $.fn.emojiarea = function (options) {
    ...
    return this.each(function () {
      ...
      if ('contentEditable' in document.body && options.wysiwyg !== false) {
        var id = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__util__["a" /* getGuid */])();
  ...
  util.emojiInserted = function (emojiKey, menu) {
    __WEBPACK_IMPORTED_MODULE_2__ConfigStorage__["a" /* default */].get('emojis_recent', function (curEmojis) {
      ...
      __WEBPACK_IMPORTED_MODULE_2__ConfigStorage__["a" /* default */].set({
  ...
  EmojiArea.createIcon = function (emoji, menu) {
    ...
    var iconSize = menu && __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].Mobile ? 26 : $.emojiarea.iconSize;
    var xoffset = -(iconSize * column);
    var yoffset = -(iconSize * row);
    var scaledWidth = __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].EmojiCategorySpritesheetDimens[category][1] * iconSize;
    var scaledHeight = __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].EmojiCategorySpritesheetDimens[category][0] * iconSize;
...
class EmojiPicker {
  ...
  generateEmojiIconSets(options) {
    ...
    j = 0;
    while (j < __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].EmojiCategories.length) {
      totalColumns = __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].EmojiCategorySpritesheetDimens[j][1];
      i = 0;
      while (i < __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].EmojiCategories[j].length) {
        dataItem = __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].Emoji[__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].EmojiCategories[j][i]];
        name = dataItem[1][0];
  ...
  colonToUnicode(input) {
    ...
    if (!__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].rx_colons) {
      __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].init_unified();
    }
    return input.replace(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].rx_colons, function (m) {
      let val = __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].mapcolon[m];
      if (val) {
        return val;
      } else {
        return '';
  ...
  appendUnicodeAsImageToElement(element, input) {
    ...
    if (!__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].rx_codes) {
      __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].init_unified();
    }

    let split_on_unicode = input.split(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].rx_codes);
    for (let text of Array.from(split_on_unicode)) {
      val = '';
      if (__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].rx_codes.test(text)) {
        val = __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].reversemap[text];
        if (val) {
          val = `:${val}:`;
    ...
    return input.replace(__WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].rx_codes, function (m) {
      val = __WEBPACK_IMPORTED_MODULE_0__Config__["a" /* default */].reversemap[m];
      if (val) {
        val = `:${val}:`;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = EmojiPicker;
;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_emoji_picker_js__ = __webpack_require__(0);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "EmojiPicker", function() { return __WEBPACK_IMPORTED_MODULE_0__js_emoji_picker_js__["a"]; });
...
/* harmony default export */ __webpack_exports__["a"] = (ConfigStorage);
