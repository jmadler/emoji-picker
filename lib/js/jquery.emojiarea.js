...
(function($, window, document) {
	...
	$.fn.emojiarea = function(options) {
		...
		return this
            ...
            var id = getGuid();
						new EmojiArea_WYSIWYG($textarea, id, options);
            $(this).attr('data-emojiable', 'false');
            $(this).attr('data-id', id);
            $(this).attr('data-type', 'original-input');
					} else {
            var id = getGuid();
						new EmojiArea_Plain($textarea, id, options);
					}
				});
	};
    ...
    $textarea.after("<i class='emoji-picker-icon fa fa-smile-o emoji-picker' data-id='" + id + "' data-type='picker'></i>");
